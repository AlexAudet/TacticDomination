namespace GleyDailyRewards
{
    ...
    public class TimerButtonManager : MonoBehaviour
    {
        ...
        public void Initialize(TimerButtonIDs buttonID, UnityAction<string, bool, string> InitializeComplete, LootChestProperty chestData, string savedTime = null)
        {
            ...
            else
            {
                ...
                if (buttonSettings != null)
                {
                    ...
                    currentTimer.timeToPass = new TimeSpan(chestData.Hour, chestData.Minute, chestData.Second);
