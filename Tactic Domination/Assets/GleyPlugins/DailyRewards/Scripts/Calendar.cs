namespace GleyDailyRewards
{
    ...
    public static class Calendar
    {
        ...
        /// </summary>
        public static void Show(bool reset = false)
        {
            CalendarManager.Instance.Initialize(reset);
        ...
        public static void AddClickListener(UnityAction<int, int, RewardType, string> ClickListener)
        {
