namespace GleyDailyRewards
{
    ...
    {
        private UnityAction<int, int, RewardType, string> ClickListener;
        ...
        public void AddClickListener(UnityAction<int, int, RewardType, string> ClickListener)
        {
        ...
        public void ButtonClick(int dayNumber, int rewardValue, RewardType RewardType, string key)
        {
            GoToNextDay();
            if (ClickListener != null)
            {
                ClickListener(dayNumber, rewardValue, RewardType, key);
            }
        }
